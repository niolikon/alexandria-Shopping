...
export const {searchClear, searchRequest, searchCompleted, searchFailure} = inventorySearchSlice.actions

// The function below is called a thunk and allows us to perform async logic. It
// can be dispatched like a regular action: `dispatch(incrementAsync(10))`. This
// will call the thunk with the `dispatch` function as the first argument. Async
// code can then be executed and other actions can be dispatched
export const doSearch = (searchKey, completedCallback) => dispatch => {
    dispatch(searchRequest(searchKey));

    axios.get(config.inventoryService + '/products', {
        params: {
            search: searchKey
        }
    })
...
export const doSearchClear = (completedCallback) => dispatch => {
...
export const selectSearchState = state => state.inventorySearch;
